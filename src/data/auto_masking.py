...
class UnetSegmentation:
    ...
    def predict(self, input_paths, output_path, model_path, output_format='jpg', edge_preserve=0.95, save_cropped_roi=True):
        ...
        for clip_index, file in enumerate(tqdm(video_files)):
            ...
            try:
                output_folder_new = os.path.join(output_path)
            ...
            frame_width = indices[3] - indices[2]
            frame_height = indices[1] - indices[0]
            video = cv2.VideoWriter(os.path.join(output_folder_new, tail[:-4] + '.mp4'),
            ...
            for frame_index in range(0, num_frames):
                ...
                if output_format == 'jpg':
                    ...
                    res = res[indices[0]:indices[1], indices[2]: indices[3], :]
                    #print(res.shape)
                    video.write(res)
